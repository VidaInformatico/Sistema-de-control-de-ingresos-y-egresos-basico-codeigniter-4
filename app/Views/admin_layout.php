            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="active-page">
                        <a href="<?= base_url('dashboard'); ?>" class="active"><i class="fa-solid fa-gauge mx-2"></i>Tablero</a>
                    </li>
                    <li>
                        <a href=""><i class="fa-solid fa-bars mx-2"></i>Administración<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                        <ul class="sub-menu">
                            <li>
                                <a href="<?= base_url('admin/empresa'); ?>">Configuración</a>
                            </li>
                            <li>
                                <a href="<?= base_url('admin/comprobantes'); ?>">Comprobantes</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="#"><i class="fa-regular fa-credit-card mx-2"></i>Caja <i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                        <ul class="sub-menu">
                            <li>
                                <a href="<?= base_url('admin/cajas'); ?>">Apertura y Cierre</a>
                            </li>
                            <li>
                                <a href="<?= base_url('admin/movimientos'); ?>">Movimientos</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-title">
                    ...
                    <li>
                        <a href="<?= base_url('logout'); ?>"><i class="fa-solid fa-power-off mx-2"></i>Cerrar Sesión</a>
                    </li>
                </ul>
            </div>
        </div>
